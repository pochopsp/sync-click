...
client:
	gcc -o client src/client/main.c src/client/left_click.c src/client/string_util.c src/client/usleep.c src/common/string_functions/string_functions.c src/common/network_constants.c -lws2_32
